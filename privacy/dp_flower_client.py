...
class DPFlowerClient(fl.client.NumPyClient):
    def __init__(self, client_id, model, csv_path,
        ...
        """
        client_id      : any string identifier, e.g. "client1"
        model          : FLClassifier — imported from fl/model.py
        ...
        # Load data — delta and num_classes are inferred from the CSV
        self.loader, delta, num_classes, _ = load_client_data(csv_path)
